/* eslint-disable */
// Fix broken import: "} , CHANCE_CARDSfrom ..." -> "CHANCE_CARDS, } from ..."
...
const old = '} , CHANCE_CARDSfrom "@monopoly/shared";';
const next = '  CHANCE_CARDS,\n} from "@monopoly/shared";';

if (!src.includes(old)) {
  console.error("broken import not found");
  process.exit(1);
}
